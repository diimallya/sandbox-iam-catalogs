...
resource "ibm_iam_access_group_members" "res_groupmem_admins" {
  ...
  ibm_ids         =  ["${var.admin_id_1}", "${var.admin_id_2}", "${var.admin_id_3}", "${var.admin_id_4}", "${var.admin_id_5}"]
}
...
resource "ibm_iam_access_group_members" "res_groupmem_users" {
  ...
  ibm_ids         =  ["${var.user_id_1}", "${var.user_id_2}", "${var.user_id_3}", "${var.user_id_4}", "${var.user_id_5}"]
}